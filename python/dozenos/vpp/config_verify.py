...
from dozenos.utils.cpu import get_core_count as total_core_count, get_cpus
...
from dozenos.vpp.config_resource_checks import memory as mem_checks
from dozenos.vpp.config_resource_checks.resource_defaults import default_resource_map
from dozenos.vpp.configdb import STORAGE_LOCATION
from dozenos.vpp.utils import human_memory_to_bytes, bytes_to_human_memory
...
def verify_routes_count(settings: dict):
    ...
    Warning(
        ...
        'Please read the documentation for details: https://docs.dozenos.io/'
    )
