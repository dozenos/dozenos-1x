...
from dozenos.utils.process import STDOUT
...
def op_mode_config_dict(
    ...
    if rc == cli_shell_api_err.DOZENOS_EMPTY_CONFIG:
        out = ''
    if rc == cli_shell_api_err.DOZENOS_INVALID_PATH:
        Warning(out)
        return {}
