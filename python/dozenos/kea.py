...
from dozenos.utils.file import file_permissions
from dozenos.utils.process import run, rc_cmd
...
def kea_get_server_leases(
    ...
    for lease in leases:
        ...
        # remove trailing dot in 'hostname' to ensure consistency for `dozenos-hostsd-client`
