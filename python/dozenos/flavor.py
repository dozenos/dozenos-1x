...
"""
DozenOS flavor data access library.

DozenOS stores its flavor specific data in a JSON file. This module provides a
...
flavor_file = os.path.join(dozenos.defaults.directories['data'], 'flavor.json')
