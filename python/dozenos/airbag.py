...
INTRO = """\
DozenOS had an issue completing a command.

We are sorry that you encountered a problem while using DozenOS.
...
- Contact us using the online help desk if you have a subscription:
  https://support.dozenos.io/
- Make sure you are running the latest version of DozenOS available at:
  https://dozenos.net/get/
- Consult the community forum to see how to handle this issue:
  https://forum.dozenos.io
- Join us on Slack where our users exchange help and advice:
  https://dozenos.slack.com
""".strip()
