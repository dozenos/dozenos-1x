...
from dozenos.template import is_ipv4, render
...
dbip_database_raw = '/usr/share/dozenos-geoip/dbip-country-lite.csv.gz'
dbip_asn_database_raw = '/usr/share/dozenos-geoip/dbip-asn-lite.csv.gz'
mm_database_raw = '/usr/share/dozenos-geoip/maxmind-country.zip'
mm_asn_database_raw = '/usr/share/dozenos-geoip/maxmind-asn.zip'
geoip_database_path = '/var/cache/dozenos/geoip-lookup.db'
geoip_lock_file = '/var/lock/dozenos-geoip.lock'
