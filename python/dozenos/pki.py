...
# {dozenos_certbot_dir}/live/<cert_name>/ - the intermediate CA certbot
...
def acme_chain_ca_entry(dozenos_certbot_dir: str, cert_name: str) -> dict:
    ...
    tmp = read_file(f'{dozenos_certbot_dir}/live/{cert_name}/chain.pem',
