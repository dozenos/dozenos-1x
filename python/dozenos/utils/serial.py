...
def get_authenticated_ports(units):
    ...
    # [2] [00000] [~~  ] [reboot  ] [~           ] [6.6.31-amd64-dozenos   ] [0.0.0.0        ] [2024-06-18T13:56:53,958484+00:00]
    # [1] [00051] [~~  ] [runlevel] [~           ] [6.6.31-amd64-dozenos   ] [0.0.0.0        ] [2024-06-18T13:57:01,790808+00:00]
    # [6] [03178] [tty1] [LOGIN   ] [tty1        ] [                    ] [0.0.0.0        ] [2024-06-18T13:57:31,015392+00:00]
    # [7] [37151] [ts/0] [dozenos    ] [pts/0       ] [10.9.8.7            ] [10.9.8.7       ] [2024-07-04T13:42:08,760892+00:00]
...
def restart_login_consoles(prompt_user=False, quiet=True, devices: List[str]=[]):
    ...
    #
    # quiet intentionally does not suppress a dozenos.base.Warning() for malformed
