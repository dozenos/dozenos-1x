...
from dozenos.component_version import VersionInfo
from dozenos.component_version import version_info_from_system
from dozenos.component_version import version_info_from_file
from dozenos.component_version import version_info_copy
from dozenos.component_version import version_info_prune_component
from dozenos.compose_config import ComposeConfig
from dozenos.compose_config import ComposeConfigError
from dozenos.configtree import ConfigTree
from dozenos.defaults import directories as default_dir
from dozenos.defaults import component_version_json


log_file = Path(default_dir['config']).joinpath('dozenos-migrate.log')
...
class ConfigMigrate:
    ...
    def run_migration_scripts(self):
        ...
        """
        os.environ['DOZENOS_MIGRATION'] = '1'
        ...
        del os.environ['DOZENOS_MIGRATION']
