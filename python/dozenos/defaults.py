...
base_dir = '/usr/libexec/dozenos'

directories = {
  'base' : f'{base_dir}',
  'data' : '/usr/share/dozenos/',
  ...
  'log' : '/var/log/vyatta',
  'templates' : '/usr/share/dozenos/templates/',
...
commit_lock = os.path.join(directories['dozenos_configdir'], '.lock')
...
rt_symbolic_names = {
  # Standard routing tables for Linux & reserved IDs for DozenOS
...
vyconfd_conf = '/etc/dozenos/vyconfd.conf'
...
'Support for SSH-DSA keys is deprecated and will be removed in DozenOS 1.6. ' \
...
reference_tree_cache = '/usr/share/dozenos/reftree.cache'
...
# empirical testing across representative DozenOS deployments:
