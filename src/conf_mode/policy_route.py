...
domain_resolver_usage = '/run/use-dozenos-domain-resolver-policy-route'
domain_resolver_usage_glob = '/run/use-dozenos-domain-resolver*'
...
def update_domain_resolver(policy):
    ...
    if domain_group_used(policy):
        text = '# Automatically generated by policy_route.py\nThis file indicates that dozenos-domain-resolver service is used by policy_route.\n'
