...
from dozenos.snmpv3_hashgen import plaintext_to_md5
from dozenos.snmpv3_hashgen import plaintext_to_sha1
from dozenos.snmpv3_hashgen import random
...
from dozenos.utils.permission import chmod_755
...
def get_config(config=None):
    ...
    # create an internal snmpv3 user of the form 'dozenosxxxxxxxxxxxxxxxx'
    snmp['dozenos_user'] = 'dozenos' + random(8)
    snmp['dozenos_user_pass'] = random(16)
    ...
    if 'listen_address' in snmp:
        ...
        # that are not configured on this system. See https://dozenos.dev/T850
