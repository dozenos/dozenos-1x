...
from dozenos.configverify import verify_pki_certificate
from dozenos.configverify import verify_pki_ca_certificate
from dozenos.configverify import verify_pki_dh_parameters
from dozenos.configdiff import get_config_diff
from dozenos.defaults import api_config_state
...
from dozenos.utils.network import is_listen_port_bind_service
...
systemd_service_api = '/run/systemd/system/dozenos-http-api.service'
...
def generate(https):
    ...
    if 'api' in https:
        render(systemd_service_api, 'https/dozenos-http-api.service.j2', https)
...
def apply(https):
    ...
    http_api_service_name = 'dozenos-http-api.service'
