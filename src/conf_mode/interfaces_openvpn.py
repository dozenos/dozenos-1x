...
from dozenos.ifconfig import VTunIf
...
from dozenos.pki import sort_ca_chain
from dozenos.pki import verify_ca_chain
from dozenos.pki import wrap_certificate
from dozenos.pki import wrap_crl
from dozenos.pki import wrap_dh_parameters
from dozenos.pki import wrap_openvpn_key
...
from dozenos.utils.list import is_list_equal
...
def verify_pki(openvpn):
    ...
    if shared_secret_key:
        ...
        DeprecationWarning('OpenVPN shared-secret support will be removed in future '\
                           'DozenOS versions. Please migrate your site-to-site tunnels to '\
        ...
        if 'topology' in openvpn['server']:
            if openvpn['server']['topology'] == 'net30':
                DeprecationWarning('Topology net30 is deprecated '\
                                   'and will be removed in future DozenOS versions. '\
