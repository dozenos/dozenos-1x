...
from dozenos.utils.dict import dict_set
...
def sync_vpp_lcp_vrf_tables(ethernet: dict, vpp_api: VPPControl) -> None:
    """Synchronize DozenOS VRF assignment to VPP IP FIB table binding."""
