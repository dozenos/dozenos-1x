...
from dozenos.hostsd_client import Client as hostsd_client
...
pdns_rec_hostsd_lua_conf_file = f'{pdns_rec_run_dir}/recursor.dozenos-hostsd.conf.lua'
...
def generate(dns):
    ...
    # if dozenos-hostsd didn't create its files yet, create them (empty)
...
def apply(dns):
    ...
    if not dns:
        ...
        ### first apply dozenos-hostsd config
        hc = hostsd_client()
