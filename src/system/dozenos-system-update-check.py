...
import dozenos.version

motd_file = Path('/run/motd.d/10-dozenos-update')
...
if __name__ == '__main__':
    ...
    local_data = dozenos.version.get_full_version_data()
    local_version = local_data.get('version')

    while True:
        remote_data = dozenos.version.get_remote_version(url_json)
        if remote_data:
            ...
            if local_version != remote_version and remote_version:
                ...
                # MOTD used in /run/motd.d/10-dozenos-update
