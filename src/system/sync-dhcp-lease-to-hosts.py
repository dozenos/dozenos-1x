...
def _get_all_server_leases(inet_suffix='4', vrf='') -> list:
    ...
    try:
        ...
        raise dozenos.opmode.DataUnavailable('Cannot fetch DHCP server leases')
...
if __name__ == '__main__':
    ...
    if inet_suffix == '6':
        raise dozenos.opmode.UnsupportedOperation(
    ...
    try:
        hc = dozenos.hostsd_client.Client()
    ...
    except dozenos.hostsd_client.DozenOSHostsdError as e:
        raise dozenos.opmode.InternalError(str(e))
