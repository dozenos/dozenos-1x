...
import dozenos.utils.vti_updown_db as _vti_mod
from dozenos.utils.vti_updown_db import VTIUpDownDB
...
class TestVTIUpDownDBLogic(unittest.TestCase):
    ...
    def test_add_makes_interface_wanted_up(self):
        ...
        with patch('dozenos.utils.vti_updown_db.Lock', MagicMock()):
    ...
    def test_seed_from_file(self):
        ...
        from dozenos.utils.vti_updown_db import open_vti_updown_db_readonly
...
class TestVTIUpDownDBLockWiring(unittest.TestCase):
    ...
    def test_create_or_update_acquires_and_releases(self):
        ...
        with patch('dozenos.utils.vti_updown_db.Lock', lock_cls):
    ...
    def test_update_acquires_and_releases(self):
        ...
        from dozenos.utils.vti_updown_db import open_vti_updown_db_for_update
