...
# T3619: mirror Linux Kernel defaults for ethernet offloading options into DozenOS
#        CLI. See https://dozenos.dev/T3619#102254 for all the details.
...
from dozenos.utils.activate import is_first_installed_boot
