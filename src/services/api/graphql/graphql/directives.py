...
class DozenosDirective(SchemaDirectiveVisitor):
...
class ConfigSessionQueryDirective(DozenosDirective):
    """
...
class ConfigSessionMutationDirective(DozenosDirective):
    """
...
class GenOpQueryDirective(DozenosDirective):
    """
...
class GenOpMutationDirective(DozenosDirective):
    """
...
class CompositeQueryDirective(DozenosDirective):
    """
...
class CompositeMutationDirective(DozenosDirective):
    """
    Class providing implementation of 'system_status' directive in schema.
    """
    def visit_field_definition(self, field, object_type):
