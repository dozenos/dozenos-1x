...
from dozenos.configtree import mask_inclusive
from dozenos.configtree import mask_exclusive
...
def set_remote_config(
    ...
    """Loads the DozenOS configuration in JSON format to a remote host.
...
def is_section_revised(section: List[str]) -> bool:
    from dozenos.config_mgmt import is_node_revised
