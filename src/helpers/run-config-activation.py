...
from dozenos.utils.activate import refresh_activation_list
from dozenos.utils.activate import get_activation_scripts
from dozenos.utils.activate import get_activation
from dozenos.utils.activate import set_activation
...
checkpoint_file = '/run/dozenos-activate-checkpoint'
log_file = Path(directories['config']).joinpath('dozenos-activate.log')
