...
from dozenos.xml_ref import get_defaults
from dozenos.wanloadbalance import health_ping_host
from dozenos.wanloadbalance import health_ping_host_ttl
from dozenos.wanloadbalance import parse_dhcp_nexthop
from dozenos.wanloadbalance import parse_ppp_nexthop
...
def cleanup(lb):
    ...
    run(f'nft delete table ip dozenos_wanloadbalance')
