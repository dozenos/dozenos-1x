...
def path_exists(s):
    if not os.path.exists(s):
        raise ArgumentTypeError("Must specify a valid dozenos-1x dependency directory")
    return s
...
def main():
    ...
    parser.add_argument('--dependency-dir', type=path_exists,
                        ...
                        help='location of dozenos-1x dependency directory')
