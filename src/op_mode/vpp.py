...
from dozenos.vpp.utils import vpp_iface_name_transform
...
# -----------------------------
# DozenOS IPFIX op-mode entries
# -----------------------------
@dozenos.opmode.verify_cli_exists(['vpp', 'ipfix', 'interface'])
def show_ipfix_interfaces(raw: bool):
    return VPPShow().ipfix_interfaces(raw)

@dozenos.opmode.verify_cli_exists(['vpp', 'ipfix', 'collector'])
def show_ipfix_collectors(raw: bool):
    return VPPShow().ipfix_collectors(raw)

@dozenos.opmode.verify_cli_exists(['vpp', 'ipfix'])
...
# -----------------------------
@dozenos.opmode.verify_cli_exists(['interfaces', 'vpp', 'bonding'])
...
# -----------------------------
@dozenos.opmode.verify_cli_exists(['interfaces', 'vpp', 'bridge'])
...
# show runtime
# -----------------------------
@dozenos.opmode.verify_cli_exists(['vpp'])
