    ...
    for group_type, group_type_conf in firewall['group'].items():
            ...
            for dynamic_type in ['address_group', 'ipv6_address_group']:
                ...
                if dynamic_type in firewall['group']['dynamic_group']:
                    for dynamic_name, dynamic_conf in firewall['group']['dynamic_group'][dynamic_type].items():
                        ...
                        members = get_nftables_group_members(family, 'dozenos_filter', f'{prefix}{dynamic_name}')
        ...
        # iterate over remote-groups
            ...
            for remote_name, remote_conf in group_type_conf.items():
                ...
                members = get_nftables_remote_group_members("ipv4", 'dozenos_filter', f'R_{remote_name}')
                members6 = get_nftables_remote_group_members("ipv6", 'dozenos_filter', f'R6_{remote_name}')
