...
#
# DozenOS is free software: you can redistribute it and/or modify it under the
# terms of the GNU General Public License as published by the Free Software
# Foundation, either version 3 of the License, or (at your option) any later
# version.
#
# DozenOS is distributed in the hope that it will be useful, but WITHOUT ANY
# WARRANTY; without even the implied warranty of MERCHANTABILITY or FITNESS
# FOR A PARTICULAR PURPOSE. See the GNU General Public License for more
# details.
#
# You should have received a copy of the GNU General Public License along with
# DozenOS. If not, see <https://www.gnu.org/licenses/>.
...
from dozenos.config_mgmt import unsaved_commits
...
from dozenos.system import grub
from dozenos.system import image
from dozenos.system import compat
from dozenos.system import raid
from dozenos.system import SYSTEM_CFG_VER
from dozenos.system import grub_util
from dozenos.template import render
from dozenos.utils.auth import DEFAULT_PASSWORD
from dozenos.utils.auth import EPasswdStrength
from dozenos.utils.auth import evaluate_strength
from dozenos.utils.auth import get_local_users
from dozenos.utils.auth import get_user_home_dir
from dozenos.utils.dict import dict_search
from dozenos.utils.io import ask_input
from dozenos.utils.io import ask_yes_no
from dozenos.utils.io import select_entry
...
MSG_INFO_INSTALL_WELCOME: str = 'Welcome to DozenOS installation!\nThis command will install DozenOS to your permanent storage.'
MSG_INFO_INSTALL_EXIT: str = 'Exiting from DozenOS installation'
...
MSG_INPUT_PASSWORD: str = 'Please enter a password for the "dozenos" user:'
MSG_INPUT_PASSWORD_CONFIRM: str = 'Please confirm password for the "dozenos" user:'
...
def configure_authentication(config_file: str, password: str) -> None:
    ...
    config.set([
        'system', 'login', 'user', 'dozenos', 'authentication',
        'encrypted-password'
    ],
...
def configure_serial_console(config_file: str, console_type: str) -> None:
    ...
    """
    from dozenos.utils.serial import is_tty
    from dozenos.utils.kernel import get_kernel_serial_console
...
def validate_signature(file_path: str, sign_type: str) -> None:
    ...
    if sign_type == 'minisig':
        pub_key_list = glob('/usr/share/dozenos/keys/*.minisign.pub')
...
def image_fetch(image_path: str, vrf: str = None,
    ...
    try:
        ...
        if urlparse(image_path).scheme:
            ...
            # DozenOS only supports minisign signatures at the moment,
...
def install_image() -> None:
    ...
    try:
        ...
        if is_raid_install(install_target):
            ...
            grub.modules_write(f'{DIR_DST_ROOT}/{grub.CFG_DOZENOS_MODULES}',
        ...
        print(f'Unable to install DozenOS: {err}')
...
def migrate_known_hosts(target_dir: str):
    ...
    # or provisioning.
    # More details: https://github.com/dozenos/dozenos-1x/pull/4678#pullrequestreview-3169648265
...
def add_image(image_path: str, vrf: str = None, username: str = '',
    ...
    try:
        ...
        if no_prompt or migrate_config():
            if Path('/dev/mapper/dozenos_config').exists():
