...
from dozenos import opmode
from dozenos import http_api_client as http
from dozenos.utils.file import read_json
from dozenos.utils.dict import dict_to_paths
from dozenos.utils.list import list_contains_sublist
from dozenos.utils.config import get_saved_config_tree
from dozenos.configtree import ConfigTree
from dozenos.configtree import ConfigTreeError
from dozenos.configtree import DiffTree
from dozenos.config import Config
from dozenos.derivedtree import apply_exclusion_list
from dozenos.derivedtree import DerivedTreeError
from dozenos.defaults import config_sync_exclusion_list
...
class ConfigSyncDiffManager:
    ...
    def _get_remote_config_tree(self, section_path: list = None) -> ConfigTree:
        ...
        Note: Endpoint name is expected to be available on remote DozenOS instance.
        """
