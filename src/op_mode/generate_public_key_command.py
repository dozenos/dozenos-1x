...
from dozenos.template import generate_uuid4
...
def get_key(path) -> list:
    ...
    if url.scheme == 'file' or url.scheme == '':
        ...
        key_string = dozenos.remote.get_remote_config(path)
...
if __name__ == "__main__":
    ...
    for k in get_key(sys.argv[2]):
        ...
        try:
            username = sys.argv[1]
            # Github keys don't have identifier for example 'dozenos@localhost'
            # 'ssh-rsa AAAA... dozenos@localhost'
