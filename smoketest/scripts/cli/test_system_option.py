...
def _get_grub_config():
    ...
    return read_file(f'{image.grub.GRUB_DIR_DOZENOS_VERS}/{image.get_running_image()}.cfg')

class TestSystemOption(DozenOSUnitTestSHIM.TestCase):
    def setUp(self):
    ...
    def test_ssh_client_options(self):
        loopback = 'lo'
        ssh_client_opt_file = '/etc/ssh/ssh_config.d/91-dozenos-ssh-client-options.conf'
    ...
    def test_kdump_base(self):
        ...
        initramfs_hook = '/etc/initramfs-tools/conf.d/zzzz-kdump-dozenos-overlay'
