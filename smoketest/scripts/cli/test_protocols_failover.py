...
config_dir_root = '/run/dozenos-failover.conf.d'
...
class TestProtocolsFailover(DozenOSUnitTestSHIM.TestCase):
    ...
    def test_01_basic(self):
        ...
        # Now dozenos-failover must be launched, it should create route, waiting for it...
    ...
    def test_04_dhcp(self):
        ...
        self.cli_set(service_base + ['option', 'domain-name', 'dozenos'])
        ...
        # Now dozenos-failover must be launched, it should create route to first dhcp address
