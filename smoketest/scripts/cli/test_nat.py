...
class TestNAT(DozenOSUnitTestSHIM.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_snat(self):
        ...
        nftables_search = ['jump DOZENOS_PRE_SNAT_HOOK']
        ...
        self.verify_nftables(nftables_search, 'ip dozenos_nat')
    ...
    def test_dnat(self):
        ...
        nftables_search = ['jump DOZENOS_PRE_DNAT_HOOK']
    ...
    def test_static_nat(self):
        ...
        self.verify_nftables(nftables_search, 'ip dozenos_static_nat')
    ...
    def test_nat_fqdn(self):
        source_domain = 'dozenos.dev'
        destination_domain = 'dozenos.io'
