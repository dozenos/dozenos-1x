...
class TestTechSupportArchive(DozenOSUnitTestSHIM.TestCase):
    def tearDown(self):
    ...
    def test_excluded_archive_files(self):
        fake_files = [
            '/opt/vyatta/etc/config/_test_fake_dozenos.iso',
            '/home/dozenos/_test_fake_dozenos.iso',
            '/tmp/_test_fake_dozenos.iso',
            '/opt/vyatta/etc/config/_test_fake_archive.tar.gz',
            '/home/dozenos/_test_fake_archive.tar.gz',
            '/tmp/_test_fake_archive.tar.gz',
            '/home/dozenos/drops-debug_9999-12-31T23-59-59',
            '/home/dozenos/ffffffffffff_tech-support-archive_9999-12-31T23-59-59',
        ...
        self.assertNotExpectedArcPaths(
            archive_path,
            [
                f'{prefix}/config.tar.gz::opt/vyatta/etc/config/_test_fake_dozenos.iso',
                f'{prefix}/home.tar.gz::home/dozenos/_test_fake_dozenos.iso',
                f'{prefix}/tmp.tar.gz::tmp/_test_fake_dozenos.iso',
                ...
                f'{prefix}/home.tar.gz::home/dozenos/_test_fake_archive.tar.gz',
                f'{prefix}/tmp.tar.gz::tmp/_test_fake_archive.tar.gz',
                f'{prefix}/home.tar.gz::home/dozenos/drops-debug_9999-12-31T23-59-59',
                f'{prefix}/home.tar.gz::home/dozenos/ffffffffffff_tech-support-archive_9999-12-31T23-59-59',
