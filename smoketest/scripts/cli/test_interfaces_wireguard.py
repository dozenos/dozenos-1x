...
from base_interfaces_test import DozenOSUnitTestSHIM
...
domain_resolver = 'dozenos-domain-resolver.service'
class WireGuardInterfaceTest(BasicInterfaceTest.TestCase):
    ...
    def test_wireguard_peer_change(self):
        ...
        self.cli_set(base_path + [interface, 'peer', 'DozenOS', 'public-key', pubkey_1])
        self.cli_set(base_path + [interface, 'peer', 'DozenOS', 'allowed-ips', allowed_ips_1])
        ...
        self.cli_set(base_path + [interface, 'peer', 'DozenOS', 'public-key', pubkey_2])
        self.cli_commit()
        ...
        # Update allowed-ips
        self.cli_delete(base_path + [interface, 'peer', 'DozenOS', 'allowed-ips', allowed_ips_1])
        self.cli_set(base_path + [interface, 'peer', 'DozenOS', 'allowed-ips', allowed_ips_2])
        self.cli_commit()
    ...
    def test_wireguard_hostname(self):
        ...
        self.cli_set(peer_base_path + ['host-name', 'wg.dozenos.net'])
    ...
    def test_wireguard_vrf_fwmark(self):
        ...
        peer_base_path = base_interface_path + ['peer', 'DozenOS']
        self.cli_set(peer_base_path + ['port', port])
        self.cli_set(peer_base_path + ['public-key', pubkey])
        self.cli_set(peer_base_path + ['allowed-ips', '169.254.0.0/16'])
        self.cli_set(peer_base_path + ['address', '192.0.2.1'])
