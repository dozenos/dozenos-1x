...
from dozenos.ifconfig import Section, Interface
...
class TestQoS(DozenOSUnitTestSHIM.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_15_traffic_match_group(self):
        interface = self._interfaces[0]
        self.cli_set(['qos', 'interface', interface, 'egress', 'DozenOS-HTB'])
        base_policy_path = ['qos', 'policy', 'shaper', 'DozenOS-HTB']
        ...
        self.cli_delete(['qos', 'interface', interface, 'egress', 'DozenOS-HTB'])
        self.cli_commit()
