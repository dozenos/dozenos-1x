...
HOSTSD_FILE = f'{PDNS_REC_RUN_DIR}/recursor.dozenos-hostsd.conf.lua'
...
class TestServicePowerDNS(DozenOSUnitTestSHIM.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_domain_forwarding(self):
        domains = ['dozenos.io', 'dozenos.net', 'dozenos.com']
        nameservers = {'192.0.2.1': {}, '192.0.2.2': {'port': '53'}, '2001:db8::1': {'port': '853'}}
