...
from dozenos.system.grub import CFG_DOZENOS_VARS
from dozenos.system.grub import vars_read
from dozenos.utils.cpu import get_cpu_arch
...
class TestSystemConsole(DozenOSUnitTestSHIM.TestCase):
    @classmethod
    def setUpClass(cls):
