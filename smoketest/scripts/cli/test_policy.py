...
class TestPolicy(DozenOSUnitTestSHIM.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_access_list(self):
        ...
        for acl, acl_config in acls.items():
            ...
            self.cli_set(path + ['description', f'DozenOS-ACL-{acl}'])
                ...
                for direction in ['source', 'destination']:
                    if direction in rule_config:
                        ...
                        if 'host' in rule_config[direction]:
                            ...
                            # possible to clean this up after the dozenos-1x migration
    ...
    def test_as_path_list(self):
        ...
        for as_path, as_path_config in test_data.items():
            ...
            self.cli_set(path + ['description', f'DozenOS-ASPATH-{as_path}'])
    ...
    def test_community_list(self):
        ...
        for comm_list, comm_list_config in test_data.items():
            ...
            self.cli_set(path + ['description', f'DozenOS-COMM-{comm_list}'])
    ...
    def test_extended_community_list(self):
        ...
        for comm_list, comm_list_config in test_data.items():
            ...
            self.cli_set(path + ['description', f'DozenOS-EXTCOMM-{comm_list}'])
            if 'rule' not in comm_list_config:
                continue
    ...
    def test_large_community_list(self):
        ...
        for comm_list, comm_list_config in test_data.items():
            ...
            self.cli_set(path + ['description', f'DozenOS-LARGECOMM-{comm_list}'])
            if 'rule' not in comm_list_config:
                continue
    ...
    def test_prefix_list(self):
        ...
        for prefix_list, prefix_list_config in test_data.items():
            ...
            self.cli_set(path + ['description', f'DozenOS-PFX-LIST-{prefix_list}'])
    ...
    def test_prefix_list_duplicates(self):
        ...
        #
        # dozenos(config)# ip prefix-list foo seq 10 permit 192.0.2.0/24
        # dozenos(config)# ip prefix-list foo seq 20 permit 192.0.2.0/24
        # % Configuration failed.
        # Error type: validation
        # Error description: duplicated prefix list value: 192.0.2.0/24

        # There is also a DozenOS verify() function to test this
    ...
    def test_route_map_community_set(self):
        ...
        for route_map, route_map_config in test_data.items():
            ...
            self.cli_set(path + ['description', f'DozenOS ROUTE-MAP {route_map}'])
    ...
    def test_route_map(self):
        ...
        # maybe change this if possible in dozenos-1x rewrite
