...
class TestProtocolsNHRP(DozenOSUnitTestSHIM.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_01_nhrp_config(self):
        ...
        nftables_search_multicast = [
            ['chain DOZENOS_NHRP_MULTICAST_OUTPUT'],
            ...
            ['chain DOZENOS_NHRP_MULTICAST_FORWARD'],
            ['type filter hook output priority filter + 10; policy accept;'],
        ...
        nftables_search_redirect = [
            ['chain DOZENOS_NHRP_REDIRECT_FORWARD'],
        ...
        self.verify_nftables(nftables_search_multicast, 'ip dozenos_nhrp_multicast')
        self.verify_nftables(nftables_search_redirect, 'ip dozenos_nhrp_redirect')
    ...
    def test_02_nhrp_multiple_tunnels(self):
        ...
        nftables_search_redirect = [['chain DOZENOS_NHRP_REDIRECT_FORWARD']]
        nftables_search_multicast = [['chain DOZENOS_NHRP_MULTICAST_OUTPUT']]
        for tunnel_if, tunnel_conf in tunnels.items():
