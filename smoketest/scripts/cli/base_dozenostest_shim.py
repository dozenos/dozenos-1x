...
# This class acts as shim between individual Smoketests developed for DozenOS and
...
class DozenOSUnitTestSHIM:
    class TestCase(unittest.TestCase):
        ...
        def verify_nftables(self, nftables_search: list[list[str]], table: str, inverse: bool=False, args: str='') -> None:
            ...
            ##### Example 1:
                Verify that the chain DOZENOS_STATE_POLICY exists and contains the specified fragments
            ...
            Parameters:
                nftables_search: list[list[str]]
                    ...
                    a match.
                table: str
                        Table spec accepted by nft (e.g. "ip dozenos_filter" or
                        "ip6 dozenos_filter").
                inverse: bool
        ...
        def verify_nftables_chain(self, nftables_search: list[list[str]], table: str, chain: str, inverse: bool=False, args: str='') -> None:
            ...
            ##### Example 1:
                ...
                Code usage:
                    ...
                    self.verify_nftables_chain(
                        nftables_search, table="ip dozenos_filter", chain="DOZENOS_INPUT_filter"
                    )
                    ```
            ...
            ##### Example 2 (inverse matching):
                ...
                Code usage:
                    ...
                    self.verify_nftables_chain(
                        nftables_search, table="ip dozenos_filter", chain="DOZENOS_INPUT_filter", inverse=True
                    )
                    ```
        ...
        def verify_nftables_chain_exists(self, table: str, chain: str, inverse: bool=False) -> None:
            ...
            ##### Example 1:
                ...
                Code usage:
                    ...
                    self.verify_nftables_chain_exists(
                        table="ip dozenos_filter", chain="DOZENOS_INPUT_filter"
                    )
                    ```
            ...
            ##### Example 2 (inverse matching):
                ...
                Code usage:
                    ```python
                    self.verify_nftables_chain_exists(
                        table="ip DOZENOS_INPUT_filter", chain="deprecated_chain", inverse=True
                    )
                    ```
