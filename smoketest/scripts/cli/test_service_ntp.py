...
class TestSystemNTP(DozenOSUnitTestSHIM.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_source_address(self):
        ...
        servers = ['time1.dozenos.net', 'time2.dozenos.net']
        for server in servers:
    ...
    def test_interleave_option(self):
        ...
        # name is not a 1:1 mapping from DozenOS config
        servers = ['192.0.2.1', '192.0.2.2']
        options = ['prefer']
