...
class TestPolicyRoute(DozenOSUnitTestSHIM.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def tearDown(self):
        ...
        nftables_search = [
            ...
            ['chain DOZENOS_PBR_smoketest']
        ]

        self.verify_nftables(nftables_search, 'ip dozenos_mangle', inverse=True)
    ...
    def test_pbr_group(self):
        ...
        nftables_search = [
            [f'iifname "{interface}"','jump DOZENOS_PBR_UD_smoketest'],
            ['ip daddr @N_smoketest_network1', 'ip saddr @N_smoketest_network'],
        ]

        self.verify_nftables(nftables_search, 'ip dozenos_mangle')
    ...
    def test_pbr_domain_group(self):
        ...
        result, code = self.wait_for_result(
            lambda: run(
                f'sudo nft get element ip dozenos_mangle '
    ...
    def test_pbr_table(self):
        ...
        nftables6_search = [
            [f'iifname "{interface}"', 'jump DOZENOS_PBR6_UD_smoketest'],
            ['meta l4proto { tcp, udp }', 'th dport 8888', 'meta mark set ' + mark_hex]
        ]

        self.verify_nftables(nftables6_search, 'ip6 dozenos_mangle')
    ...
    def test_pbr_matching_criteria(self):
        ...
        # IPv4
        nftables_search = [
            ['iifname { "' + interface + '", "' + interface_wc + '" }', 'jump DOZENOS_PBR_UD_smoketest'],
        ...
        # IPv6
        nftables6_search = [
            [f'iifname "{interface_wc}"', 'jump DOZENOS_PBR6_UD_smoketest'],
    ...
    def test_geoip(self):
        ...
        self.verify_nftables(nftables_search, 'ip dozenos_mangle', args='-t')
        ...
        self.verify_nftables(nftables_search, 'ip6 dozenos_mangle', args='-t')
