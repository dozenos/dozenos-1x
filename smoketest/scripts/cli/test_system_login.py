...
users = ['dozenos1', 'dozenos-roxx123', 'DozenOS-123_super.Nice']
...
tac_image_path = '/usr/share/dozenos/tacplus-alpine.tar'
TAC_PLUS_TMPL_SRC = """
id = spawnd {
...
radius_image_path = '/usr/share/dozenos/radius-latest.tar'
...
class TestSystemLogin(DozenOSUnitTestSHIM.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_system_login_user(self):
        ...
        for user in users:
            ...
            # b'Linux dozenos 6.6.66-dozenos 6.6.66-dozenos #1 SMP Mon Dec 30 19:05:15 UTC 2024 x86_64 GNU/Linux\n'
    ...
    def test_system_user_ssh_key(self):
        ...
        public_keys = 'dozenos_test@domain-foo.com'
        type = 'ssh-rsa'
    ...
    def test_system_login_max_login_session(self):
        ...
        security_limits = read_file('/etc/security/limits.d/10-dozenos.conf')
