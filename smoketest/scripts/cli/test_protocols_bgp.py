...
class TestProtocolsBGP(DozenOSUnitTestSHIM.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_bgp_05_afi_ipv6(self):
        ...
        # T2100: By default ebgp-requires-policy is disabled to keep DozenOS
