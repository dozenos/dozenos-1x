...
class TestSNMPService(DozenOSUnitTestSHIM.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_snmp_basic(self):
        ...
        contact = 'maintainers@dozenos.local'
        location = 'QEMU'
        ...
        self.assertEqual('DozenOS ' + version_data['version'], config)
    ...
    def test_snmpv3_md5(self):
        ...
        with self.assertRaises(ConfigSessionError):
            self.cli_commit()
        self.cli_set(base_path + ['v3', 'user', 'dozenos', 'group', snmpv3_group])
