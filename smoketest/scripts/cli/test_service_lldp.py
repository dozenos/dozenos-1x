...
PROCESS_NAME = 'lldpd'
LLDPD_CONF = '/etc/lldpd.d/01-dozenos.conf'
base_path = ['service', 'lldp']
mgmt_if = 'dum83513'
mgmt_addr = ['1.2.3.4', '1.2.3.5']

class TestServiceLLDP(DozenOSUnitTestSHIM.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_01_lldp_basic(self):
        ...
        self.assertIn(f'configure system platform DozenOS', config)
        self.assertIn(f'configure system description "DozenOS {version}"', config)
