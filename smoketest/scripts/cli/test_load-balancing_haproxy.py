...
from dozenos.template import get_default_port
...
def parse_haproxy_config() -> dict:
    ...
    return sections
class TestLoadBalancingReverseProxy(DozenOSUnitTestSHIM.TestCase):
    def tearDown(self):
    ...
    def test_reverse_proxy_domain(self):
        ...
        frontend = 'dozenos_smoketest'
        front_port = '4433'
        bk_server_first = '192.0.2.11'
        bk_server_second = '192.0.2.12'
        bk_first_name = 'dozenosbk-01'
        bk_second_name = 'dozenosbk-02'
        bk_server_port = '9090'
        mode = 'http'
        rule_ten = '10'
        rule_twenty = '20'
