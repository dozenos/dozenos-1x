...
from dozenos.template import dec_ip
...
HOSTSD_CLIENT = '/usr/bin/dozenos-hostsd-client'
...
class TestServiceDHCPServer(DozenOSUnitTestSHIM.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_dhcp_single_pool_options(self):
        ...
        smtp_server = '1.2.3.4'
        time_server = '4.3.2.1'
        tftp_server = 'tftp.dozenos.io'
        search_domains = ['foo.dozenos.net', 'bar.dozenos.net']
        bootfile_name = 'dozenos'
        bootfile_server = '192.0.2.1'
        wpad = 'http://wpad.dozenos.io/foo/bar'
    ...
    def test_dhcp_multiple_pools(self):
        ...
        for network in ['0', '1', '2', '3']:
            shared_net_name = f'DozenOS-SMOKETEST-{network}'
    ...
    def test_dhcp_high_availability(self):
        ...
        failover_name = 'DozenOS-Failover'
    ...
    def test_dhcp_hostsd_lease_sync(self):
        ...
        # All up and running, now test dozenos-hostsd store
