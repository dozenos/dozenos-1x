...
from dozenos.vpp.utils import vpp_ip_addresses_by_index
...
class TestVPP(DozenOSUnitTestSHIM.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_17_2_vpp_pppoe_invalid_vif(self):
        ...
        # More details here: https://dozenos.dev/T8276
        with self.assertRaisesRegex(ConfigSessionError, err_msg):
            self.cli_commit()
    ...
    def test_18_1_kernel_options_hugepages(self):
        ...
        tmp = read_file(
            f'{image.grub.GRUB_DIR_DOZENOS_VERS}/{image.get_running_image()}.cfg'
        )
