# Contributing to DozenOS

You want to help us improve DozenOS? This is awesome!
...
In a big system, such as DozenOS, that is comprised of multiple components, it’s
...
* Help future maintainers of DozenOS (it could be you!) to find out why certain
...
If there is no [development portal](https://dozenos.dev) reference in the
...
This is nothing DozenOS specific - it is more a general topic for distributed
...
## Bug Report/Issue
Issues or bugs are found in any software project. DozenOS is not an exception.
...
* Consult our [Documentation](https://docs.dozenos.io) to ensure that you have
  configured your system correctly
* Get community support via [Slack](https://slack.dozenos.io) or our online
  [Forum](https://forum.dozenos.io)
...
an account in the [development portal](https://dozenos.dev). On the left
side of the specific project (DozenOS 1.2 or DozenOS 1.3) you will find quick-links
for opening a bug-report/feature request.

* Provide as much information as you can
* Which version of DozenOS are you using? Use operational level command:
  ``show version``
...
You have an idea of how to make DozenOS better or you are in need of a specific
feature which all users of DozenOS would benefit from? To send a feature request
please search the [development portal](https://dozenos.dev) if there is already a
...
For contributing code to DozenOS please take a short moment and review the guideline
outlined in our Documentation at
https://docs.dozenos.io/en/latest/contributing/development.html#submit-a-patch

### Coding Guidelines

We have some small coding guidelines which are defined in a separate section of
at https://docs.dozenos.io/en/latest/contributing/development.html#coding-guidelines.
...
It might also worth browsing our [Blog](https://blog.dozenos.io) for additional
info and updates.
