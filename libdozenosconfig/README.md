...
This library mixes the multiway tree manipulation libraries from [vyconf](https://github.com/dozenos/vyconf)
with a parser and a formatter for DozenOS 1.x config format, and is meant to be used in config migration scripts
...
```
# Clone and install the dozenos1x-config library
git clone https://github.com/dozenos/dozenos1x-config
opam pin add dozenos1x-config .
